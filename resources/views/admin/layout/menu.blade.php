<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin/baihat/danhsach"><i class="fa fa-dashboard fa-fw"></i> Trang chủ</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Bài Hát<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/baihat/danhsach">Danh sách bài hát</a>
                    </li>
                    <li>
                        <a href="admin/baihat/them">Thêm Bài hát</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
